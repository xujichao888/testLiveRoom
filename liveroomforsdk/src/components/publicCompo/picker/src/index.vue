      ...
      <transition name="toup">
        <div class="vue-picker" ref="picker" v-show="visible">
          ...
          <div class="content" :style="{height: boxHeight + 'px'}">
            ...
            <div class="hairline">
                <div class="year blockss"></div>
                <div class="mouth blockss"></div>
                <div class="day blockss"></div>
            </div>
          </div>
          <div class="dones">
            <div class="sizess">
               <pubBtn :isActive="true" text="Done" @click.native="confirm"/>
            </div>
          </div>
        </div>
      </transition>
...
<style lang="scss" scoped>
  ...
  .hairline {
    ...
    .blockss{
      width: 300px;
      height: 120px;
      background: rgba(170,125,255,0.1);
      border-radius: 30px;
    }
  }
</style>
